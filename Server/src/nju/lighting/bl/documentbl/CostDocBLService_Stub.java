...
public class CostDocBLService_Stub implements CostDocBLService {
    ...
    public CostDocVO createCostDoc() throws RemoteException {
        ...
        ArrayList<CostDocItem> items = new ArrayList<>();
        CostDocItem item0 = new CostDocItem(CostDocItemType.ACCOMMODATION, 1000, "Excited!");
        CostDocItem item1 = new CostDocItem(CostDocItemType.TRANSPOTATION, 1500, "I'm angry");
        items.add(item0);
        items.add(item1);
