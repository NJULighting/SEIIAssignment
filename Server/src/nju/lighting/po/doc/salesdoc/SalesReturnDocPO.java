...
public class SalesReturnDocPO extends SalesTypeDocPO {
     ...
     * 代金券金额
     */
    public SalesReturnDocPO(String SalesTypeDocID, String customerId, String salesman, String repository, String userId, String remarks, double beforeDiscountAmount, double discount, double voucher) {
