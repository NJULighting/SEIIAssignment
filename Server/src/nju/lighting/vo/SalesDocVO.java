...
public class SalesDocVO extends SalesTypeDocVO {
     ...
     * 代金券金额
     */
    public SalesDocVO(String SalesTypeDocID, String customerId, String salesman, String repository, String userId, String remarks, double beforeDiscountAmount, double discount, double voucher) {
