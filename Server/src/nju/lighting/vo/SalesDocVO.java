...
public class SalesDocVO extends DocVO{
    ...
    public SalesDocVO(String ID,CustomerVO customer,String salesman,String repository,UserVO operator,CommodityListVO commodityList,String remarks,double beforeDiscountAmount,double discount,double voucher,double finalAmount){
        this.ID =ID;
