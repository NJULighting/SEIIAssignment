...
|  扩展流程  | 2a.非法关键字<br>1.系统提示错误并拒绝输入<br>2b.非法客户编号<br>1.系统提示错误并拒绝输入<br>2c.销售人员修改应收额度<br>1.系统查询系统用户的权限<br>2.若不是最高权限，则提示没有最高权限拒绝修改<br>2d.销售人员增加已经存在的客户<br>1.系统拒绝添加并提示客户已经存在 |
