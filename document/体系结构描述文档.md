...
数据库中包含Commodity表、AlertDoc表、AlertDocItem表、CommodityCategory表、HistoryDoc表、LossAndGainDoc表、LossAndGainDocItem表、RepositoryChange表、Customer表、StockDoc表、StockReturnDoc表、SaleDoc表、SaleReturnDoc表、UserInfo表、UserLog表、Account表、AccountIODoc表、AccountTransfer表、CostDoc表、Log表、InitInfo表 、Promotion表、GiftDoc表、GiftDocItem表 
