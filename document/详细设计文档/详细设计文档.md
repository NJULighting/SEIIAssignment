...
| DocController.redflushAndCopy           | 前置条件 | 已经创建一个Doc领域对象，传入有效的DocVO对象               |
|                                         | 后置条件 | 调用Doc领域对象的redflushAndCopy方法              |
|                                         | 语法   | `public DocVO createDoc(DocType type)  ` |
| DocController.createDoc                 | 前置条件 | 已经创建一个Doc领域对象，传入非空的DocType               |
|                                         | 后置条件 | 调用Doc领域对象的createDoc方法                    |
